...
| Skill | Papel |
|---|---|
| **Validação de artefato** | `mgr spec validate` verifica o **plano** de uma feature: dependência inexistente, ciclo no DAG, granularidade, task sem critério de done ou sem o artefato declarado. Formato declarado por marcador, chaves em inglês e valores no seu idioma; **nenhum plano antigo é reprovado** (ADR-0012). |
